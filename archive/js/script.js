$(document).ready(function() {
    ...
    $("#stop_id").keypress(function(a) {
        13 != a.keyCode && 13 != a.which || triageInput()
    });
    $("#input2").keypress(function(a) {
        13 != a.keyCode && 13 != a.which || addressSearch()
    })
});
...
function triageInput() {
    input = $("#stop_id").val();
    if (input.length <= 5) {
        for (var a = 0; a < bus_stops_array.length; a++) bus_stops_array[a] === input && updateStopData();
    } 
	else {
